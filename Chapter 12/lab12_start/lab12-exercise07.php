...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if(is_array($_FILES['file1']['error'])) {
		...
		//We every file to make sure there was no upload error
		//before writing to permanent folder
		...
		if ($_FILES['file1']['error'] == UPLOAD_ERR_OK) {
			...
			$serviceName = $_FILES['file1']['tmp_name'];
